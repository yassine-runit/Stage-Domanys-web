...
const Sidebar = ({ onFilterChange, selectedPatrimoine, selectedCollaborators = [], selectedServices = [] }) => {
    ...
    const handleCollaboratorChange = (id) => {
        const newSelectedCollaborators = selectedCollaborators.includes(id)
            ? selectedCollaborators.filter(item => item !== id)
            : [...selectedCollaborators, id];

        onFilterChange(newSelectedCollaborators, selectedServices, selectedPatrimoine);
    };

    const handleServiceChange = (id) => {
        const newSelectedServices = selectedServices.includes(id)
            ? selectedServices.filter(item => item !== id)
            : [...selectedServices, id];

        onFilterChange(selectedCollaborators, newSelectedServices, selectedPatrimoine);
    };
